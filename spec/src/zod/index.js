...
exports.VersionSchema =
  ...
  exports.InstructionsSchem =
  exports.EventsSchema =
  exports.ErrorsSchema =
  exports.ConstantsSchema =
  exports.AccountsSchema =
    void 0;
var zod_1 = require("zod");
var types_1 = require("./types");
exports.AccountsSchema = zod_1.z.array(
  zod_1.z.object({
...
exports.ConstantsSchema = zod_1.z.array(
  zod_1.z.object({
...
exports.ErrorsSchema = zod_1.z.array(
  zod_1.z.object({
    code: zod_1.z.number(),
    name: zod_1.z.string(),
...
exports.EventsSchema = zod_1.z.array(
  zod_1.z.object({
    name: zod_1.z.string(),
    fields: zod_1.z.array(
      zod_1.z.object({
        name: zod_1.z.string(),
        type: types_1.IdlTypeSchema,
...
exports.InstructionsSchem = zod_1.z.array(
  zod_1.z.object({
    name: zod_1.z.string(),
    docs: zod_1.z.optional(zod_1.z.array(zod_1.z.string())),
...
exports.TypesSchema = zod_1.z.optional(
  zod_1.z.array(
    zod_1.z.object({
      name: zod_1.z.string(),
