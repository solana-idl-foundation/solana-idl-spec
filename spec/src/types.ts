...
// Enum variants
const idlDataEnumVariantWithNamedFieldsSchema =
  z.object({
    name: z.string(),
    fields: z.array(IdlFieldSchema)
  });

const idlDataEnumVariantWithUnnamedFieldsSchema =
  z.object({
    name: z.string(),
...
export const EnumTypeSchema: z.ZodSchema<IdlTypeDefTyEnum> =
  z.union([
...
export const IdlTypeDefSchema: z.ZodSchema<IdlTypeDefTy> = z.union([EnumTypeSchema, StructTypeSchema]);
